<?php
    ...
    $config['static'][$nametype]['width'] = 668;
    $config['static'][$nametype]['height'] = 514;
    $config['static'][$nametype]['thumb'] = '668x514x1';
    ...
    $nametype = "tai-khoang-ngan-hang";
    $config['static'][$nametype]['title_main'] = "Tài khoảng ngân hàng";
    $config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
    $config['static'][$nametype]['name'] = true;
    $config['static'][$nametype]['desc'] = true;
    ...
    $config['static'][$nametype]['title_main'] = "Hỗ trợ trực tuyến";
    $config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
    $config['static'][$nametype]['images'] = true;
    $config['static'][$nametype]['desc'] = true;
    $config['static'][$nametype]['desc_cke'] = true;
    $config['static'][$nametype]['seo'] = true;
    $config['static'][$nametype]['width'] = 127;
    $config['static'][$nametype]['height'] = 127;
    $config['static'][$nametype]['thumb'] = '127x127x1';
    $config['static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
?>